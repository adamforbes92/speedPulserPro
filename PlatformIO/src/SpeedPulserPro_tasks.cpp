...
void tasksSuspendAll() {
  if (taskEEPHandle != NULL) vTaskSuspend(taskEEPHandle);
  if (taskUIUpdateHandle != NULL) vTaskSuspend(taskUIUpdateHandle);
  if (taskGPSHandle != NULL) vTaskSuspend(taskGPSHandle);
  if (taskDSGHandle != NULL) vTaskSuspend(taskDSGHandle);
  if (taskSpeedHandle != NULL) vTaskSuspend(taskSpeedHandle);
  if (taskRPMHandle != NULL) vTaskSuspend(taskRPMHandle);
  if (taskBroadcastSpeedHandle != NULL) vTaskSuspend(taskBroadcastSpeedHandle);
 ...
 */
void tasksResumeAll() {
  if (taskEEPHandle != NULL) vTaskResume(taskEEPHandle);
  if (taskUIUpdateHandle != NULL) vTaskResume(taskUIUpdateHandle);
  if (taskGPSHandle != NULL) vTaskResume(taskGPSHandle);
